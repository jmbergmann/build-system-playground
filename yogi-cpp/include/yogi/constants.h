...
struct constants {
  ...
  /// Address of the network interface that is used by default.
  static const std::string kDefaultInterfaceAddress;
...
_YOGI_WEAK_SYMBOL const std::string constants::kDefaultInterfaceAddress =
